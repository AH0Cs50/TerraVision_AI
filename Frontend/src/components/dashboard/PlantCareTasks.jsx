...
import { NeedsFeed } from "../../ui/Icons";
// NeedsFeed
const PlantCareTasks = () => {
  return (
    <>
      {/* 3. Plant Care Tasks Section */}
      <div className="space-y-4">
        <h3 className="text-sm font-bold text-[#111827]">Plant Care Tasks</h3>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {/* Tomato Tasks Container */}
          <div className="bg-white border border-[#E5E7EB] rounded-2xl p-4 shadow-sm space-y-3">
            <div className="flex justify-between items-center border-b border-[#F3F4F6] pb-2">
              <div className="flex items-center space-x-2 text-xs font-bold text-[#374151]">
                ...
                <span>Tomato Tasks Today</span>
              </div>
              <button className="w-5 h-5 rounded-full border border-[#D1D5DB] flex items-center justify-center text-xs text-[#6B7280] hover:border-[#0A3D24]">
                +
              </button>
            </div>
            ...
            <div className="space-y-2 w-full">
               <label className="flex items-center justify-between p-3 bg-[#F9FAFB] border border-[#E5E7EB] rounded-xl cursor-pointer hover:bg-white transition group select-none">
                <div className="flex items-center space-x-3">
                  <input
                    type="checkbox"
                    className="w-4 h-4 rounded text-[#0A3D24] focus:ring-[#0A3D24] border-[#D1D5DB]"
                  />
                  <div className="text-xs">
                    <p className="font-semibold text-[#374151] group-hover:text-[#0A3D24] transition-colors">
                      Apply Nutrient
                    </p>
                    <p className="text-[10px] text-[#6B7280]">
                      Potassium boost needed
                    </p>
                  </div>
                </div>
          ...
          <div className="bg-white border border-[#E5E7EB] rounded-2xl p-4 shadow-sm space-y-3">
            <div className="flex justify-between items-center border-b border-[#F3F4F6] pb-2">
              <div className="flex items-center space-x-2 text-xs font-bold text-[#374151]">
                ...
                <span>Cucumber Tasks Today</span>
              </div>
              <button className="w-5 h-5 rounded-full border border-[#D1D5DB] flex items-center justify-center text-xs text-[#6B7280] hover:border-[#0A3D24]">
                +
              </button>
