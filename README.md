...
| [`Backend/service/engine/`](Backend/service/engine/) | Rule engine — 7-layer scoring system for water, fertilizer, pest, light ([README](Backend/service/engine/README.md), [report](Backend/service/engine/report.md)) |
