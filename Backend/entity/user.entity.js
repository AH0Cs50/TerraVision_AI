class User {
  ...
  getRefreshToken() { return this.#data.refreshToken; }

  changePassword(newHashed) { this.#data.password = newHashed; }
  setRefreshToken(token) { this.#data.refreshToken = token; }
  clearRefreshToken() { this.#data.refreshToken = null; }

  toJSON() { return { ...this.#data }; }

  toSafeObject() {
    const { uuid, name, email, role, isverified, location, createdAt } = this.#data;
